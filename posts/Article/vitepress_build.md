...
### 自定义首页
vitepress有三个预设的layout可以选择：home page和doc，如果想要用自定义主页请将index.md如下设置
```js
---
layout: page
---
...
一开始我随手选择了home，而VPHome有一个自带的padding-bottom，调整了半天发现主页最下面总有一处内边距的留白，后来才发现是这里的问题，将layout改为page后完美解决

### 应用自定义组件（component）
vitepress支持自行编写vue组件并引入layout预设好的插槽（slot）中（前提是你没有像上文那样更换全局主题），详见官方文档
