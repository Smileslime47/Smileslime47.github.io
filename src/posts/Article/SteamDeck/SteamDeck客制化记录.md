...
![Steam菜单](image/SteamDeck客制化记录/capymenu-steam-1024x640.jpg)

![QAM菜单](image/SteamDeck客制化记录/capymenu-qam-new-1024x640.jpg)

![Context菜单](image/SteamDeck客制化记录/capymenu-context-1024x640.jpg)

### Centered Home

将主页游戏库图标居中放大显示，并将其他内容放在下一页，这样更有主机端的感觉

![](image/SteamDeck客制化记录/centered-home-1024x640.jpg)

### Clean Gameview

将游戏页面的样式修改为大篇幅封面Hero + 页脚启动栏透明的风格，其余内容放在下一页

![](image/SteamDeck客制化记录/clean-gameview-1024x640.jpg)

### Clean Game Launch

使游戏启动画面显示游戏Logo而非Gamepad映射说明，毕竟大部分人也不太想看这个

![](image/SteamDeck客制化记录/clean-game-launch-1024x640.jpg)
